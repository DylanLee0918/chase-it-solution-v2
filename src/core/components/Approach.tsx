...
const Approach: FunctionComponent = () => {
  return (
    <React.Fragment>
      <section
        id='approach'
        className={`w-full sm:${styles.marginY} my-24 flex flex-col justify-center sm:items-center`}
      >
        <div className='flex flex-col justify-center items-center'>
          ...
          <p
            className={`${styles.paragraph} font-poppins font-normal md:text-[24px] mt-6`}
          >
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            {ourApproachData.map((data) => (
              <div className='py-8 px-8 bg-discount-gradient rounded-[10px] mb-2 z-[5]'>
                ...
                <div>
                  <p
                    className={` font-poppins font-normal text-dimWhite sm:text-[18px] sm:leading-[30.8px] mt-2 z-[5] text-[14px]`}
                  >
                    {data.description}
                  </p>
                </div>
