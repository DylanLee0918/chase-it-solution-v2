...
const Introduction: FunctionComponent = () => {
  return (
    <React.Fragment>
      <section
        id='company-overview'
        className='w-full sm:mt-44 mt-24 flex flex-col justify-center sm:items-center'
      >
        <h3 className='font-poppins font-semibold text-[36px] text-white'>
          <span className='text-gradient'>Introduction</span>
        </h3>
        <p
          className={`${styles.paragraph} mt-5 z-[5] font-normal sm:text-center`}
        >
